...
public class EmailUtils {
	...
	// 发件人 账号和密码
	public static final String MY_EMAIL_ACCOUNT = "grand_ranfs@163.com";
	public static final String MY_EMAIL_PASSWORD = "ranfs123";// 密码,是你自己的设置的授权码
	...
	// 收件人
	public static final String RECEIVE_EMAIL_ACCOUNT = "ran_fusheng@163.com";
